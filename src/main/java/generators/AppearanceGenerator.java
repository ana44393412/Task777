...
public final class AppearanceGenerator implements Generator<Appearance> {

    private String eyes;
    private int hairLength;
    private String hairColor;

    private static AppearanceGenerator instance;

    private AppearanceGenerator() {
    }

    public static AppearanceGenerator getInstance() {
        if (instance == null) {
            instance = new AppearanceGenerator();
        }
        return instance;
    }
    ...
    @Override
    public Appearance buildResponse() {
        Hair hair;
        if (hairLength > 0) {
    ...
    @Override
    public Appearance getResult(final int code) {
        generateParams(code);
